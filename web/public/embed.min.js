(function(){const configKey="difyChatbotConfig";const buttonId="dify-chatbot-bubble-button";const iframeId="dify-chatbot-bubble-window";const config=window[configKey];let isExpanded=false;const svgIcons=`<svg id="openIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M60 40 Q100 10 140 40 C150 60 150 120 140 160 L130 180 L70 180 L60 160 C50 120 50 60 60 40 Z" fill="#000000"/>
      <circle cx="100" cy="80" r="50" fill="#ffe0d6"/>
      <path d="M70 60 Q80 55 90 60" stroke="#8b5a2b" stroke-width="3" fill="none"/>
      <path d="M110 60 Q120 55 130 60" stroke="#8b5a2b" stroke-width="3" fill="none"/>
      <circle cx="80" cy="75" r="8" fill="#000000"/>
      <circle cx="120" cy="75" r="8" fill="#000000"/>
      <circle cx="82" cy="73" r="2" fill="#ffffff"/>
      <circle cx="122" cy="73" r="2" fill="#ffffff"/>
      <path d="M90 95 Q100 100 110 95" stroke="#000000" stroke-width="2" fill="none"/>
      <ellipse cx="65" cy="85" rx="8" ry="5" fill="#ffc0cb" opacity="0.5"/>
      <ellipse cx="135" cy="85" rx="8" ry="5" fill="#ffc0cb" opacity="0.5"/>
      <path d="M60 70 Q55 80 60 90" fill="#ffe0d6"/>
      <path d="M140 70 Q145 80 140 90" fill="#ffe0d6"/>
      <circle cx="55" cy="75" r="5" fill="#c0c0c0"/>
      <rect x="135" y="70" width="10" height="10" rx="2" fill="#c0c0c0"/>
      <circle cx="140" cy="75" r="2" fill="#888888"/>
      <rect x="80" y="120" width="40" height="30" fill="#ffffff"/>
      <path d="M90 120 Q100 115 110 120" fill="#ffffff"/>
      <path d="M70 120 Q80 115 90 120 L80 150 L60 150 Z" fill="#000000"/>
      <path d="M130 120 Q120 115 110 120 L120 150 L140 150 Z" fill="#000000"/>
    </svg>
